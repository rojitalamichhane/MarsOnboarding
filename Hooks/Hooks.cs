...
namespace qa_dotnet_cucumber.Hooks
{
    ...
    public class Hooks
    {
        ...
        public static void BeforeTestRun()
        {
            ...
            var deserializedSettings = JsonSerializer.Deserialize<TestSettings>(json);
            if (deserializedSettings == null)
            {
                throw new InvalidOperationException("Failed to deserialize settings.json into TestSettings.");
            }
